...
export default function RegisterPage() {
  ...
  const handleOAuth = async (provider: 'google' | 'github') => {
    try {
      ...
      setOauthNote(
        `${provider.toUpperCase()} OAuth requires toggling on the provider in your Supabase dashboard. Please sign up with Email & Password below!`
      )
      error(`${provider.toUpperCase()} Not Enabled`, 'Please sign up with Email & Password below.')
    }
  }
    ...
    <div className="min-h-screen bg-stone-950 flex flex-col justify-center py-12 px-4 sm:px-6 lg:px-8">
      ...
      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
        <div className="bg-stone-900/90 border border-stone-800 p-8 rounded-3xl shadow-xl space-y-5">
          {/* Email Sign Up Form (Works Immediately) */}
          ...
          <div className="relative">
            ...
            <div className="relative flex justify-center text-xs uppercase">
              <span className="bg-stone-900 px-2 text-stone-500 font-medium">Or Social Sign Up</span>
            </div>
          </div>
